...
def Inception_V3(features, labels, mode):
    ...
    weights = {
        ...
        'conv_6_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 192, 64], mean=0, stddev=1e-2)),
        'conv_6_2_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 192, 48], mean=0, stddev=1e-2)),
        'conv_6_2_2_gpu': tf.Variable(tf.truncated_normal([5, 5, 48, 64], mean=0, stddev=1e-2)),
        'conv_6_3_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 192, 64], mean=0, stddev=1e-2)),
        'conv_6_3_2_gpu': tf.Variable(tf.truncated_normal([3, 3, 64, 96], mean=0, stddev=1e-2)),
        'conv_6_3_3_gpu': tf.Variable(tf.truncated_normal([3, 3, 96, 96], mean=0, stddev=1e-2)),
        'conv_6_4_2_gpu': tf.Variable(tf.truncated_normal([1, 1, 192, 32], mean=0, stddev=1e-2)),
        'conv_7_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 256, 64], mean=0, stddev=1e-2)),
        'conv_7_2_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 256, 48], mean=0, stddev=1e-2)),
        'conv_7_2_2_gpu': tf.Variable(tf.truncated_normal([5, 5, 48, 64], mean=0, stddev=1e-2)),
        'conv_7_3_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 256, 64], mean=0, stddev=1e-2)),
        'conv_7_3_2_gpu': tf.Variable(tf.truncated_normal([3, 3, 64, 96], mean=0, stddev=1e-2)),
        'conv_7_3_3_gpu': tf.Variable(tf.truncated_normal([3, 3, 96, 96], mean=0, stddev=1e-2)),
        'conv_7_4_2_gpu': tf.Variable(tf.truncated_normal([1, 1, 256, 64], mean=0, stddev=1e-2)),
        'conv_9_2_gpu': tf.Variable(tf.truncated_normal([3, 3, 288, 384], mean=0, stddev=1e-2)),
        'conv_9_3_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 288, 64], mean=0, stddev=1e-2)),
        ...
        'conv_14_2_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 768, 192], mean=0, stddev=1e-2)),
        'conv_14_2_2_gpu': tf.Variable(tf.truncated_normal([3, 3, 192, 320], mean=0, stddev=1e-2)),
        'conv_14_3_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 768, 192], mean=0, stddev=1e-2)),
        'conv_14_3_2_gpu': tf.Variable(tf.truncated_normal([1, 7, 192, 192], mean=0, stddev=1e-2)),
        'conv_14_3_3_gpu': tf.Variable(tf.truncated_normal([7, 1, 192, 192], mean=0, stddev=1e-2)),
        'conv_14_3_4_gpu': tf.Variable(tf.truncated_normal([3, 3, 192, 192], mean=0, stddev=1e-2)),
        'conv_15_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 1280, 320], mean=0, stddev=1e-2)),
        'conv_15_2_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 1280, 384], mean=0, stddev=1e-2)),
        'conv_15_2_2_1_gpu': tf.Variable(tf.truncated_normal([1, 3, 384, 384], mean=0, stddev=1e-2)),
        'conv_15_2_2_2_gpu': tf.Variable(tf.truncated_normal([3, 1, 384, 384], mean=0, stddev=1e-2)),
        'conv_15_3_1_gpu': tf.Variable(tf.truncated_normal([1, 1, 1280, 448], mean=0, stddev=1e-2)),
        'conv_15_3_2_gpu': tf.Variable(tf.truncated_normal([3, 3, 448, 384], mean=0, stddev=1e-2)),
        'conv_15_3_3_1_gpu': tf.Variable(tf.truncated_normal([1, 3, 384, 384], mean=0, stddev=1e-2)),
        'conv_15_3_3_2_gpu': tf.Variable(tf.truncated_normal([3, 1, 384, 384], mean=0, stddev=1e-2)),
        'conv_15_4_2_gpu': tf.Variable(tf.truncated_normal([1, 1, 1280, 192], mean=0, stddev=1e-2)),
        'conv_17_gpu': tf.Variable(tf.truncated_normal([1, 1, 1280, 1001], mean=0, stddev=1e-2)),
    }
    ...
    # 64*1*1*192 same stride=1
    conv_6_1_gpu = tf.nn.conv2d(input=max_pooling_2_gpu,
                                 filters=weights['conv_6_1_gpu'],
                                 strides=[1, 1, 1, 1],
                                 padding='SAME',
                                 name='conv_6_1_gpu')

    relu_6_1_gpu = tf.nn.relu(features=conv_6_1_gpu,
                               name='relu_6_1_gpu')

    # 48*1*1*192 same stride=1
    conv_6_2_1_gpu = tf.nn.conv2d(input=max_pooling_2_gpu,
                                   filters=weights['conv_6_2_1_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_6_2_1_gpu')

    relu_6_2_1_gpu = tf.nn.relu(features=conv_6_2_1_gpu,
                                 name='relu_6_2_1_gpu')

    # 64*5*5*48 same stride=1
    conv_6_2_2_gpu = tf.nn.conv2d(input=relu_6_2_1_gpu,
                                   filters=weights['conv_6_2_2_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_6_2_2_gpu')

    relu_6_2_2_gpu = tf.nn.relu(features=conv_6_2_2_gpu,
                                 name='relu_6_2_2_gpu')

    # 64*1*1*192 same stride=1
    conv_6_3_1_gpu = tf.nn.conv2d(input=max_pooling_2_gpu,
                                   filters=weights['conv_6_3_1_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_6_3_1_gpu')

    relu_6_3_1_gpu = tf.nn.relu(features=conv_6_3_1_gpu,
                                 name='relu_6_3_1_gpu')

    # 96*3*3*64 same stride=1
    conv_6_3_2_gpu = tf.nn.conv2d(input=relu_6_3_1_gpu,
                                   filters=weights['conv_6_3_2_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_6_3_2_gpu')

    relu_6_3_2_gpu = tf.nn.relu(features=conv_6_3_2_gpu,
                                 name='relu_6_3_2_gpu')

    # 96*3*3*96 same stride=1
    conv_6_3_3_gpu = tf.nn.conv2d(input=relu_6_3_2_gpu,
                                   filters=weights['conv_6_3_3_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_6_3_3_gpu')

    relu_6_3_3_gpu = tf.nn.relu(features=conv_6_3_3_gpu,
                                 name='relu_6_3_3_gpu')

    # filter_size=3 same stride=1
    average_pool_6_4_1_gpu = tf.nn.avg_pool2d(value=max_pooling_2_gpu,
                                               ksize=3,
                                               strides=1,
                                               padding='SAME',
                                               name='average_pool_6_4_1_gpu')

    # 32*1*1*192 same stride=1
    conv_6_4_2_gpu = tf.nn.conv2d(input=average_pool_6_4_1_gpu,
                                   filters=weights['conv_6_4_2_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_6_4_2_gpu')

    relu_6_4_2_gpu = tf.nn.relu(features=conv_6_4_2_gpu,
                                 name='relu_6_4_2_gpu')

    # 15
    concat_1_gpu = tf.concat(
        values=[relu_6_1_gpu, relu_6_2_2_gpu, relu_6_3_3_gpu, relu_6_4_2_gpu], axis=3, name='concat_1_gpu')

    # 64*1*1*256 same stride=1
    conv_7_1_gpu = tf.nn.conv2d(input=concat_1_gpu,
                                 filters=weights['conv_7_1_gpu'],
                                 strides=[1, 1, 1, 1],
                                 padding='SAME',
                                 name='conv_7_1_gpu')

    relu_7_1_gpu = tf.nn.relu(features=conv_7_1_gpu,
                               name='relu_7_1_gpu')

    # 48*1*1*256 same stride=1
    conv_7_2_1_gpu = tf.nn.conv2d(input=concat_1_gpu,
                                   filters=weights['conv_7_2_1_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_7_2_1_gpu')

    relu_7_2_1_gpu = tf.nn.relu(features=conv_7_2_1_gpu,
                                 name='relu_7_2_1_gpu')

    # 64*5*5*48 same stride=1
    conv_7_2_2_gpu = tf.nn.conv2d(input=relu_7_2_1_gpu,
                                   filters=weights['conv_7_2_2_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_7_2_2_gpu')

    relu_7_2_2_gpu = tf.nn.relu(features=conv_7_2_2_gpu,
                                 name='relu_7_2_2_gpu')

    # 64*1*1*256 same stride=1
    conv_7_3_1_gpu = tf.nn.conv2d(input=concat_1_gpu,
                                   filters=weights['conv_7_3_1_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_7_3_1_gpu')

    relu_7_3_1_gpu = tf.nn.relu(features=conv_7_3_1_gpu,
                                 name='relu_7_3_1_gpu')

    # 96*3*3*64 same stride=1
    conv_7_3_2_gpu = tf.nn.conv2d(input=relu_7_3_1_gpu,
                                   filters=weights['conv_7_3_2_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_7_3_2_gpu')

    relu_7_3_2_gpu = tf.nn.relu(features=conv_7_3_2_gpu,
                                 name='relu_7_3_2_gpu')

    # 96*3*3*96 same stride=1
    conv_7_3_3_gpu = tf.nn.conv2d(input=relu_7_3_2_gpu,
                                   filters=weights['conv_7_3_3_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_7_3_3_gpu')

    relu_7_3_3_gpu = tf.nn.relu(features=conv_7_3_3_gpu,
                                 name='relu_7_3_3_gpu')

    # filter_size=3 same stride=1
    average_pool_7_4_1_gpu = tf.nn.avg_pool2d(value=concat_1_gpu,
                                               ksize=3,
                                               strides=1,
                                               padding='SAME',
                                               name='average_pool_7_4_1_gpu')

    # 64*1*1*256 same stride=1
    conv_7_4_2_gpu = tf.nn.conv2d(input=average_pool_7_4_1_gpu,
                                   filters=weights['conv_7_4_2_gpu'],
                                   strides=[1, 1, 1, 1],
                                   padding='SAME',
                                   name='conv_7_4_2_gpu')

    relu_7_4_2_gpu = tf.nn.relu(features=conv_7_4_2_gpu,
                                 name='relu_7_4_2_gpu')

    # 24
    concat_2_gpu = tf.concat(
        values=[relu_7_1_gpu, relu_7_2_2_gpu, relu_7_3_3_gpu, relu_7_4_2_gpu], axis=3, name='concat_2_gpu')
    ...
    # 192*1*7*192 same stride=1
    conv_14_3_2_gpu = tf.nn.conv2d(input=relu_14_3_1_gpu,
                                    filters=weights['conv_14_3_2_gpu'],
                                    strides=[1, 1, 1, 1],
                                    padding='SAME',
                                    name='conv_14_3_2_gpu')

    relu_14_3_2_gpu = tf.nn.relu(features=conv_14_3_2_gpu,
                                  name='relu_14_3_2_gpu')

    # 192*7*1*192 same stride=1
    conv_14_3_3_gpu = tf.nn.conv2d(input=relu_14_3_2_gpu,
                                    filters=weights['conv_14_3_3_gpu'],
                                    strides=[1, 1, 1, 1],
                                    padding='SAME',
                                    name='conv_14_3_3_gpu')

    relu_14_3_3_gpu = tf.nn.relu(features=conv_14_3_3_gpu,
                                  name='relu_14_3_3_gpu')

    # 192*3*3*192 valid stride=2
    conv_14_3_4_gpu = tf.nn.conv2d(input=relu_14_3_3_gpu,
